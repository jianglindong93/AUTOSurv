...
setwd("D:/DL/TCGA data/TCGA-GDC-OV/data_split/train_test_split/no_normalization")
# genes
...
setwd("D:/DL/TCGA data/TCGA-GDC-OV/TCGA_OV_WGCNA_tryouts")
net = blockwiseModules(datExpr, power = 4, maxBlockSize = 5147,
                       TOMType = "unsigned", minModuleSize = 30,
                       reassignThreshold = 0, mergeCutHeight = 0.25,
                       numericLabels = TRUE, pamRespectsDendro = FALSE,
                       saveTOMs = TRUE,
                       saveTOMFileBase = "TCGAOVTOM_gene",
                       verbose = 3)
table(net$colors)
...
save(MEs, moduleLabels, moduleColors, geneTree,
     file = "TCGAOV_gene-01-networkConstruction-auto.RData")
...
setwd("D:/DL/TCGA data/TCGA-GDC-OV/TCGA_OV_WGCNA_tryouts")
net_mirna = blockwiseModules(datExpr_mirna, power = 3, maxBlockSize = 865,
                             TOMType = "unsigned", minModuleSize = 30,
                             reassignThreshold = 0, mergeCutHeight = 0.25,
                             numericLabels = TRUE, pamRespectsDendro = FALSE,
                             saveTOMs = TRUE,
                             saveTOMFileBase = "TCGAOVTOM_mirna",
                             verbose = 3)
...
save(MEs2, moduleLabels2, moduleColors2, geneTree2,
     file = "TCGAOV_mirna-01-networkConstruction-auto.RData")
...
root_dir<-"D:/DL/TCGA data/TCGA-GDC-OV/data_split"
