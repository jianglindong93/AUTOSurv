...
setwd("D:/AUTOSurv/ICGC_data/OV_AU/divided_data_new/div_5/train_test_split/no_normalization")
# genes
...
setwd("D:/AUTOSurv/ICGC_data/OV_AU/divided_data_new/div_5/WGCNA")
net = blockwiseModules(datExpr, power = 5, maxBlockSize = 8739,
                       TOMType = "unsigned", minModuleSize = 30,
                       reassignThreshold = 0, mergeCutHeight = 0.25,
                       numericLabels = TRUE, pamRespectsDendro = FALSE,
                       saveTOMs = TRUE,
                       saveTOMFileBase = "OVAU_gene",
                       verbose = 3)
table(net$colors)
...
save(MEs, moduleLabels, moduleColors, geneTree,
     file = "ovau_gene-05-networkConstruction-auto.RData")
...
setwd("D:/AUTOSurv/ICGC_data/OV_AU/divided_data_new/div_5/WGCNA")
net_mirna = blockwiseModules(datExpr_mirna, power = 10, maxBlockSize = 753,
                             TOMType = "unsigned", minModuleSize = 30,
                             reassignThreshold = 0, mergeCutHeight = 0.25,
                             numericLabels = TRUE, pamRespectsDendro = FALSE,
                             saveTOMs = TRUE,
                             saveTOMFileBase = "OVAU_mirna",
                             verbose = 3)
...
save(MEs2, moduleLabels2, moduleColors2, geneTree2,
     file = "ovau_mirna-05-networkConstruction-auto.RData")
...
root_dir<-"D:/AUTOSurv/ICGC_data/OV_AU/divided_data_new/div_5"
